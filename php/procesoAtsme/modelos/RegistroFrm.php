...
class RegistroFrm {
    ...
    function registrarSegumientosSWF($loteProceso, $arraySeguimientos, $swReflujo){
        $pivoteSeguimiento = 0;
        $resultado  = false;
        $nroHoraSeguimiento;
