                        ...
                        <center>
                            ...
                            <div class="container">
                                ...
                                <div class="row mt-3 pt-3">
                                    ...
                                    <p class="fs-5 text-decoration-underline text-center fw-bold">En caso de respuesta
                                        negativa, contactar a Mnatentenimiento para hacer las correcciones necesarias.
                                    </p>
                                    <div class="col-6 mx-auto">
                                        <label>Si <input type="radio" name="conexionesAcoplesTuberiasOk" value="1"
                                                required>
                                    </div>
                                    <div class="col-6 mx-auto">
                                        <label>No<input type="radio" name="conexionesAcoplesTuberiasOk" value="0"
                                                required>
                                    </div>
                                </div>
                                ...
                                <div class="row mt-3 pt-3">
                                    ...
                                    <div class="col-3 mt-5 mx-auto">
                                        <label>Inicio carga:<input type="datetime-local" placeholder="inicioCarga"
                                                name="inicioCargaTOO000">
                                    </div>
                                    <div class="col-3 mt-5 mx-auto">
                                        <label>Fin carga:<input type="datetime-local" placeholder="finCarga"
                                                name="finCargaTOO000">
                                    </div>
                                </div>
                                ...
                                <div class="row mt-3 pt-3">
                                    ...
                                    <p class="fs-5 text-decoration-underline text-center fw-bold">Si la respuesta es
                                        ...
                                        solucion.</p>
                                    <div class="col-3 mt-5 mx-auto">
                                        <label>Si <input type="radio" name="problemaCarga">
                                    </div>
                                    <div class="col-3 mt-5 mx-auto">
                                        <label>No<input type="radio" name="problemaCarga">
                                    </div>
                                </div>
