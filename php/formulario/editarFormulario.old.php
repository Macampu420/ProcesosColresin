            ...
            <section id="formulario">
                ...
                <form id="formNfo" name="formNfo" method="POST" action="guardarFormulario.php">
                    ...
                    <fieldset>
                        ...
                        <div class="container">
                            ...
                            <input type="number" id="nan000" placeholder="Kg"  name="nan000"  size="12px" value="<?php echo $nan000; ?>" <?php echo $d_nan000; ?> />
                            <label for="swf098">SWF098: </label>
                            <input type="number" id="swf098" placeholder="Kg"  name="swf098" value="<?php echo $swf098; ?>" <?php echo $d_swf098; ?> />
                            <label for="stw000">STW000: </label>
                            <input type="number" id="stw000" placeholder="Kg"  name="stw000" value="<?php echo $stw000; ?>" <?php echo $d_stw000; ?> />
                            <label for="fdo037">FDO037: </label>
                            <input type="number" id="fdo037" placeholder="Kg"  name="fdo037" value="<?php echo $fdo037; ?>" <?php echo $d_fdo037; ?> />
                            <label for="myo000">MYO000: </label>
                            <input type="number" id="myo000" placeholder="Kg"  name="myo000" value="<?php echo $myo000; ?>" <?php echo $d_myo000; ?> />
                            <label for="fdo037">STW000: </label>
                            <input type="number" id="stw0002" placeholder="Kg"  name="stw0002" value="<?php echo $stw0002; ?>" <?php echo $d_stw0002; ?> />
                            <label for="csc050">CSC050: </label>
                            <input type="number" id="csc050" placeholder="Kg"  name="csc050" value="<?php echo $csc050; ?>" <?php echo $d_csc050; ?> />
                            <label for="fdo037">STW000: </label>
                            <input type="number" id="stw0003" placeholder="Kg"  name="stw0003" value="<?php echo $stw0003; ?>" <?php echo $d_stw0003; ?> /> 
                        </div>
                ...
                <form id="formNfo" name="formNfo" method="POST" action="guardarFormulario.php">
                        ...
                        <div class="container" id="CheckEquipo" style="display: <?php echo $displayMatPriSeparada;?>;">
                            ...
                            <h4>Chequeo del Equipo</h4>
                            <p>¿El proceso anterior es el mismo a realizar y/o el reactor esta completamente limpio?</p>
                            <table class="table" style="width:50%;">
                                <tr>
                            ...
                            <div class="container" id="limpiezaEquipo" style="display: <?php echo $displayReactorLimpio;?>;">
                                ...
                                <div id="phsodatanque" style="display: <?php echo $displayEmisionesFunciona; ?>;">
                                    ...
                                    <div id="CondensadorFunciona" style="display: <?php echo $displayCondensadorFunciona;?>">
                                        <p>¿ El condensador no presenta escapes y funciona correctamente ?</p>
                                        <table class="table" style="width:50%;">
                                            <tr>
                    ...
                    <form id="formNfo" name="formNfo" method="POST" action="guardarFormulario.php">
                        ...
                        <div class="container" id="InicioProceso" style="display: <?php echo $displayInicioProceso;?>;">
                            <h4>Inicio del Proceso</h4><hr>

                            <h4>Carga del NAN000</h4>

                            <b>¿Leyó la ficha y hoja de seguridad (FS-01y FS-01-1) para este producto?</b><br />
                            <a href="img/FDS Naftaleno tecnico.pdf" target="popup" onclick="window.open('img/FDS Naftaleno tecnico.pdf','popup','width=888,height=600'); return false;">
                        ...
                        <div class="container" id="TrituradoSaco" style="display: <?php echo $TrituradoSaco;?>;">
                            ...
                            <label> <b>¿Cerro el sistema de enfriamiento para evitar obstrucción de las lineas con 700NAN000 sublimado?</b> 
                            ...
                            <div class="container" id="TrituradoSaco2" style="display: <?php echo $TrituradoSaco2; ?>;">
                                ...
                                <b>Inicie Fusion del naftaleno presurizando la camisa del reactor máximo a 60 PSI hasta que la tempertura alcance T= 95-100°C.</b>             <br />
                                ...
                                <div class="container" id="AfirmativaRespuesta" style="display: <?php echo $AfirmativaRespuesta; ?>">
                                    ...
                                    <input type="text" name="ProblemaFundirNaf" size="100" value="<?php echo $ProblemaFundirNaf; ?>" <?php echo $d_ProblemaFundirNaf; ?>>
                                    <hr>
                                </div>
                                <hr>
                                <input type="submit" value="Guardar y Continuar" class="boton boton-opcion rounded-3">
                ...
                <form id="formNfo" name="formNfo" method="POST" action="guardarFormulario.php">
                        ...
                        <div class="container" id="Carga710" style="display: <?php echo $Carga710; ?>;">
                            <hr>
                            <h4>Carga del 710SWF098</h4>
                            <b>¿Leyó la ficha y hoja de seguridad (FS-01y FS-01-1) para este producto?</b><br />
                            <a href="img/FDS Acido Sulfúrico.pdf" target="popup" onclick="window.open('img/FDS Acido Sulfúrico.pdf','popup','width=889,height=600'); return false;">Ver Ficha de Seguridad</a><br />
                            <table class="table" style="width:50%;">
                                <tr>
                        ...
                        <div class="container" id="CargueSWF098" style="display: <?php echo $CargueSWF098; ?>;">
                            ...
                            <br />
                            <b>Inicie adición de (2) SWF098 al reactor en 60 minutos aproximadamente.</b><br />
                            ...
                            <p style="color: red;"><i><u>Durante la adición se puede formar vacío dentro del equipo, controlar por medio del embudo.  Una vez se presente de nuevo presión y se note salida de vapor o gases cerrar el embudo y abrir el sistema de control para iniciar su lavado de gases.</u></i></p>
                            ...
                            <input type="number" id="presionswfo1" placeholder="PSI" name="presionswfo1" value="<?php echo $presionswfo1;?>" <?php echo $d_presionswfo1; ?>/> 
                            ...
                            <br />
                            <b>Sostener temperatura T = 140-150°C y reacción durante 3 horas.</b><br />
                            ...
                            <input type="number" id="presionhr1" placeholder="PSI" name="presionhr1" value="<?php echo $presionhr1;?>" <?php echo $d_presionhr1; ?>/><hr>
                            <b>Hora 2</b><br />
                            ...
                            <input type="number" id="presionhr2" placeholder="PSI" name="presionhr2" value="<?php echo $presionhr2;?>" <?php echo $d_presionhr2; ?>/><hr>
                            <b>Hora 3</b><br />
                            ...
                            <input type="number" id="presionhr3" placeholder="PSI" name="presionhr3" value="<?php echo $presionhr3;?>" <?php echo $d_presionhr3; ?>/><hr>
                            ...
                            <b>Terminadas las 3 horas de reacción. Enfrie  a T = 85 - 90°C,  con reflujo directo y restablezca el suministro de agua en el condensador.</b><br />
                            ...
                            <input type="number" id="presionenfriado" placeholder="PSI" name="presionenfriado" value="<?php echo $presionenfriado; ?>" <?php echo $d_presionenfriado; ?>/> 
                            <hr>
                            <h4>Carga del 700STW00</h4><br />
                            <b>Adicione (3) STW000 en 1 hora como tiempo maximo con reflujo directo y enfriar hasta conseguir una temperatura T = 85 - 90°C. </b><br />
                            ...
                            <input type="number" id="presionadicionstw" placeholder="PSI" name="presionadicionstw" value="<?php echo $presionadicionstw; ?>" <?php echo $d_presionadicionstw; ?>/>
                            <br />
                            ...
                            <hr>
                            <h4>Carga del 700FDO035 y 710MYO000</h4><br />
                            <b>¿Leyó la ficha y hoja de seguridad (FS-01y FS-01-1) para estos productos?</b> <br />
                            <a href="img/FDS Formol al 37_.pdf" target="popup" onclick="window.open('img/FDS Formol al 37_.pdf','popup','width=861,height=600'); return false;">Ver Ficha de Seguridad Formol</a>
                            <a href="img/FDS Metanol.pdf" target="popup" onclick="window.open('img/FDS Metanol.pdf','popup','width=861,height=600'); return false;">Ver Ficha de Seguridad Metanol</a>
                            <br />
                            <table class="table" style="width:50%;">
                                <tr>
                    ...
                    <form id="formNfo" name="formNfo" method="POST" action="guardarFormulario.php">
                        ...
                        <div class="container" id="RevisoConexion" style="display: <?php echo $RevisoConexion; ?>;">
                            ...
                            <label> <b>Para el bombeo del 710MYO000 Y 700FDO035 (Inflamables) cuenta con una bomba neumatica o en su defecto una previamente revisada.</b> 
                            ...
                            <label> <b>Las conexiones eléctricas y acoples de manguera y tubería estén bien hechas.</b> 
                            ...
                            <br />
                            <i>Capacidad del tanque de adición: 500 Kilos</i>
                        </div>
                    
                        <!-- Paso 9 -->
                        <div class="container" id="Carga700" style="display: <?php echo $Carga700; ?>">
                            <hr>
                            <h4>Inicio de la carga de 700FDO035 Y 710MYO000</h4><br />
                            ...
                            <br />
                            <i><u>"SIN VAPOR y desde el tanque de adición, en 4 horas como tiempo mínimo (puede ser mayor según comportamiento de la reacción),  adicionar la mezcla (4) FDO037 y  (5) MYO000. Inicialmente sube la temperatura hasta T = 102°C y después baja lentamente hasta terminar la adición entre T = 98 - 100°C."</u></i><br />
                            <hr>
                            ...
                            <input type="number" id="presionadc1" placeholder="PSI" name="presionadc1" value="<?php echo $presionadc1; ?>" <?php echo $d_presionadc1;?>  />
                            ...
                            <input type="number" id="presionadc2" placeholder="PSI" name="presionadc2" value="<?php echo $presionadc2; ?>" <?php echo $d_presionadc2;?>  />
                            <b>Observaciones/Comentarios</b>
                            ...
                            <input type="number" id="presionadc3" placeholder="PSI" name="presionadc3" value="<?php echo $presionadc3; ?>" <?php echo $d_presionadc3;?>  />
                            <b>Observaciones/Comentarios</b>
                            ...
                            <input type="number" id="presionadc4" placeholder="PSI" name="presionadc4" value="<?php echo $presionadc4; ?>" <?php echo $d_presionadc4;?>  />
                            <b>Observaciones/Comentarios</b>
                            <input type="text" name="comentarioadc4" value="<?php echo $comentarioadc4; ?>" <?php echo $d_comentarioadc4;?>  /><hr>
                            <b>Hora 5</b><br />
                            ...
                            <input type="number" id="presionadc5" placeholder="PSI" name="presionadc5" value="<?php echo $presionadc5; ?>" <?php echo $d_presionadc5;?>  />
                            <b>Observaciones/Comentarios</b>
                            ...
                            <b>Sostener durante 7 horas a T = 98 - 102 °C.  Sin Vapor. Inicialmente sube la temperatura hasta T = 102°C y después baja lentamente hasta terminar la adición entre T = 95 - 100°C.  <i> <u>Si es necesario dar pase de vapor por poco tiempo para sostener la temperatura en el rango T = 98 - 102°C.</u></i></b>
                            ...
                            <input type="number" id="presionreac1" placeholder="PSI" name="presionreac1" value="<?php echo $presionreac1; ?>" <?php echo $d_presionreac1; ?>/>
                            <b>Observaciones/Comentarios</b>
                            ...
                            <input type="number" id="presionreac2" placeholder="PSI" name="presionreac2" value="<?php echo $presionreac2; ?>" <?php echo $d_presionreac2; ?>/>
                            <b>Observaciones/Comentarios</b>
                            ...
                            <input type="number" id="presionreac3" placeholder="PSI" name="presionreac3" value="<?php echo $presionreac3; ?>" <?php echo $d_presionreac3; ?>/>
                            <b>Observaciones/Comentarios</b>
                            ...
                            <input type="number" id="presionreac4" placeholder="PSI" name="presionreac4" value="<?php echo $presionreac4; ?>" <?php echo $d_presionreac4; ?>/>
                            <b>Observaciones/Comentarios</b>
                            ...
                            <input type="number" id="presionreac5" placeholder="PSI" name="presionreac5" value="<?php echo $presionreac5; ?>" <?php echo $d_presionreac5; ?>/>
                            <b>Observaciones/Comentarios</b>
                            ...
                            <input type="number" id="presionreac6" placeholder="PSI" name="presionreac6" value="<?php echo $presionreac6; ?>" <?php echo $d_presionreac6; ?> />
                            <b>Observaciones/Comentarios</b>
                            ...
                            <input type="number" id="presionreac7" placeholder="PSI" name="presionreac7" value="<?php echo $presionreac7; ?>" <?php echo $d_presionreac7;?>/>
                            <b>Observaciones/Comentarios</b>
                    ...
                    <form id="formNfo" name="formNfo" method="POST" action="guardarFormulario.php">
                        ...
                        <div class="container" id="AdicionarSTW" style="display: <?php echo $AdicionarSTW;?>;">
                            ...
                            <input type="number" id="presionadcstw2" placeholder="PSI" name="presionadcstw2" value="<?php echo $presionadcstw2; ?>" <?php echo $d_presionadcstw2; ?>/>
                            ...
                            <b>¿Leyó la ficha y hoja de seguridad (FS-01y FS-01-1) para estos productos?</b><br />
                            <a href="img/FDS Soda Caustica Liquida.pdf" target="popup" onclick="window.open('img/FDS Soda Caustica Liquida.pdf','popup','width=859,height=600'); return false;">Ver Ficha de Seguridad</a><br />
                            <table class="table" style="width:50%;">
                                <tr>
                    ...
                    <form id="formNfo" name="formNfo" method="POST" action="guardarFormulario.php">
                        ...
                        <div class="container" id="ReaccionNeutra" style="display: <?php echo $ReaccionNeutra;?>;">
                            <b>Adicionar (7) CSC050 en 4 horas como tiempo máximo conservando T = 94 - 95 °C.</b>
                            ...
                            <input type="number" id="presionneut1" placeholder="PSI" name="presionneut1" value="<?php echo $presionneut1; ?>" <?php echo $d_presionneut1; ?> />
                            <b>Observaciones/Comentarios</b>
                            ...
                            <input type="number" id="presionneut2" placeholder="PSI" name="presionneut2" value="<?php echo $presionneut2; ?>" <?php echo $d_presionneut2; ?> />
                            <b>Observaciones/Comentarios</b>
                            ...
                            <input type="number" id="presionneut3" placeholder="PSI" name="presionneut3" value="<?php echo $presionneut3; ?>" <?php echo $d_presionneut3; ?> />
                            <b>Observaciones/Comentarios</b>
                            ...
                            <label for="presionreac4">Presión de Vapor:</label>
                            <input type="number" id="presionneut4" placeholder="PSI" name="presionneut4" value="<?php echo $presionneut4; ?>" <?php echo $d_presionneut4; ?> />
                            <b>Observaciones/Comentarios</b>
                            ...
                            <input type="number" id="presionhomoge1" placeholder="PSI" name="presionhomoge1" value="<?php echo $presionhomoge1; ?>" <?php echo $d_presionhomoge1; ?> />
                            <b>Observaciones/Comentarios</b>
                            ...
                            <input type="number" id="presionhomoge2" placeholder="PSI" name="presionhomoge2" value="<?php echo $presionhomoge2; ?>" <?php echo $d_presionhomoge2; ?> />
                            <b>Observaciones/Comentarios</b>
                            ...
                            <input type="number" id="presionhomoge3" placeholder="PSI" name="presionhomoge3" value="<?php echo $presionhomoge3; ?>" <?php echo $d_presionhomoge3; ?> />
                            <br />
                            ...
                            <hr>
                            <b>Evaluar presencia de olor a formol, si hay presencia adicionar CSC050.</b><br />
                            <b>Hay presencia de olor a FDO035? </b><br />
                            <table class="table" style="width:50%;">
                                <tr>
                    ...
                    <form id="formNfo" name="formNfo" method="POST" action="guardarFormulario.php">
                        ...
                        <div class="container" id="Enfriet85" style="display: <?php echo $Enfriet85; ?>">
                            ...
                            <div id="ProcesoDescarga" style="display: <?php echo $ProcesoDescarga; ?>;">
                                ...
                                <br />
                            <!-- <b>Notificar al laboratorio para visto bueno.</b><br /> -->
                    ...
                    <form id="formNfo" name="formNfo" method="POST" action="guardarFormulario.php">
                        ...
                        <!-- Validar los dos check que no continuen sino estan checkeados -->
                            ...
                            <input type="number" step="any" id="pH10Final" name="pH10Final" placeholder="pH" value="<?php echo $pH10Final; ?>" <?php echo $d_pH10Final; ?>/>
