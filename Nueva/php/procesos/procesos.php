...
$query = $_process->get_only_process();
...
while ($row = $query->fetch_array(MYSQLI_BOTH)){
    ...
    if($row['Estado'] == 1){
        ...
        if($idrol == 0 || $idrol == 3){
            $eliminar = "<a href='procesos.php?id=" . $row['IdProceso'] . "'><i class='fas fa-trash'></i></a>";
        }
...
<body>
    ...
    <main class="contenedor seccion contenido-centrado">
        ...
        <div class="container">
            <?php echo $btn; ?>
            <button type="button" class="boton-add" onclick="window.location.href='procesosTodos.php'"><i class="fa fa-eye" aria-hidden="true"></i> Ver todos</button>
            </div>
        <div class="container">
